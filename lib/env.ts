...
const envSchema=z.object({
  ...
  ADMIN_EMAILS:z.string().default(""),BOARD_EMAILS:z.string().default(""),AGENT_EMAILS:z.string().default(""),DEV_EMAILS:z.string().default(""),ACCOUNTANT_EMAILS:z.string().default(""),
